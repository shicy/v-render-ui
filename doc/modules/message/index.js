...
const UIMessage = VRender.UIMessage;

const ModuleView = BaseModule.extend(module, {
	getTitle: function () {
		return "UIMessage 提示框";
	},
	...
	renderDemo1: function (render) {
		...
		demo.append(new UIButton(this, { ref: "message_btn1", label: "点击打开提示框" }));

		// 后端构建
		demo.append(new UIMessage(this, { content: "这是一条消息提示，由服务端创建。" }));
	...
	renderDemo2: function (render) {
		...
		demo.append(new UIButton(this, { ref: "message_btn21", label: "默认" }));
		demo.append(new UIButton(this, { ref: "message_btn22", label: "成功" }));
		demo.append(new UIButton(this, { ref: "message_btn23", label: "错误" }));
		demo.append(new UIButton(this, { ref: "message_btn24", label: "警告" }));
		demo.append(new UIButton(this, { ref: "message_btn25", label: "消息" }));

		let source = [];
		source.push("new UIMessage([context], {\n  content: '默认提示框'\n});");
		source.push("new UIMessage([context], {\n  content: '成功信息',\n  type: 'success'\n});");
		source.push("new UIMessage([context], {\n  content: '失败、错误信息',\n  type: 'error'\n});");
		source.push("new UIMessage([context], {\n  content: '警告信息',\n  type: 'warn'\n});");
		source.push("new UIMessage([context], {\n  content: '消息信息',\n  type: 'info'\n});");
	...
	renderDemo3: function (render) {
		...
		let demo = new UIGroup(this, { gap: 10, orientation: this.suggestOrientation });
		demo.append(new UIButton(this, { ref: "message_btn31", label: "默认3秒关闭" }));
		demo.append(new UIButton(this, { ref: "message_btn32", label: "自定义30秒后关闭" }));
		demo.append(new UIButton(this, { ref: "message_btn33", label: "不自动关闭" }));
	...
	renderDemo4: function (render) {
		...
		demo.append(new UIButton(this, { ref: "message_btn41", label: "不可关闭" }));
	...
	renderDemo5: function (render) {
		...
		let demo = new UIGroup(this, { gap: 10 });
		demo.append(new UIButton(this, {ref: "message_btn51", label: "使用 HTML 消息"}));
	...
	renderDemo6: function (render) {
		...
		let demo = new UIGroup(this, { gap: 10 });
		demo.append(new UIButton(this, {ref: "message_btn61", label: "自定义图标"}));
