...
const ModuleView = BaseModule.extend(module, {
	...
	renderDemo1: function (render) {
		...
		demo.append(new UIInput(this, { prompt: "请输入.." }));

		let source = [];
		source.push("new UIInput([context], {\n  prompt: '请输入..'\n});");
	...
	renderDemo2: function (render) {
		...
		let demo = new UIGroup(this, { gap: 10 });
		demo.append(new UIInput(this, { prompt: "请输入..", multi: true }));
	...
	renderDemo3: function (render) {
		...
		demo.add(new UIGroup(this))
			...
			.append(new UIInput(this, { type: "number", prompt: "请输入数字",
				desc: "数字类型输入框，只能输入数字，默认保留2位小数" }));
		demo.add(new UIGroup(this))
			.append($("label.demo-lbl").text("type: 'email'"))
			.append(new UIInput(this, { type: "email", prompt: "请输入电子邮箱",
				desc: "电子邮箱类型输入框，验证输入框内容为电子邮箱格式" }));
		demo.add(new UIGroup(this))
			.append($("label.demo-lbl").text("type: 'password'"))
			.append(new UIInput(this, { type: "password", prompt: "请输入密码",
				desc: "密码输入框，内容不可见" }));
		demo.add(new UIGroup(this))
			.append($("label.demo-lbl").text("type: 'tel'"))
			.append(new UIInput(this, { type: "tel", prompt: "请输入电话号码或手机号",
				desc: "电话号码输入框，验证输入框内容为电话号码或手机号" }));
		demo.add(new UIGroup(this))
			.append($("label.demo-lbl").text("type: 'url'"))
			.append(new UIInput(this, { type: "url", prompt: "请输入网址", value: "http://",
	...
	renderDemo4: function (render) {
		...
		demo.append(new UIInput(this, { value: "该文本框只读，不能输入", readonly: true }));
		demo.append(new UIInput(this, { value: "该文本框只读，不能输入", readonly: true, multi: true }));
	...
	renderDemo5: function (render) {
		...
		let demo = new UIGroup.VGroup(this, { gap: 10 });
		demo.append(new UIInput(this, { prompt: "文本框不能为空", required: true }));
		demo.add(new UIGroup(this))
			.append($("label.demo-lbl").text("自定义提示信息"))
			.append(new UIInput(this, { prompt: "文本框不能为空", required: true, empty: "自定义提示信息" }));
		demo.append(new UIInput(this, { prompt: "文本框不能为空", required: true, multi: true }));
	...
	renderDemo6: function (render) {
		...
		demo.add(new UIGroup(this))
			...
			.append(new UIInput(this, { prompt: "文本框提示信息" }));
		demo.add(new UIGroup(this))
			.append($("label.demo-lbl").text("使用 tips 属性"))
			.append(new UIInput(this, { tips: "提示" }));
		demo.add(new UIGroup(this))
			.append($("label.demo-lbl").text("使用 desc 属性"))
			.append(new UIInput(this, { desc: "文本框备注信息，说明性文本内容。" }));
	...
	renderDemo7: function (render) {
		...
		let demo = new UIGroup.VGroup(this, { gap: 10 });
		demo.append(new UIInput(this, { type: "number", prompt: "请输入数字，默认2为小数" }));
		demo.append(new UIInput(this, { type: "number", prompt: "请输入数字，默认3为小数", decimals: 3 }));
		demo.append(new UIInput(this, { type: "number", prompt: "请输入10-20之间的数字", decimals: 0, min: 10, max: 20 }));
	...
	renderDemo8: function (render) {
		...
		let demo = new UIGroup.VGroup(this, { gap: 10 });
		demo.append(new UIInput(this, { type: "email", prompt: "请输入电子邮箱", errmsg: "亲，邮箱地址不是这样滴！" }));
		demo.append(new UIInput(this, { prompt: "请输入名称，必须是字母、数字或_，最少6个字符", multi: true,
	...
	renderDemo9: function (render) {
		...
		demo.add(new UIGroup(this))
			.append($("label.demo-lbl").text("type: 'password'"))
			.append(new UIInput(this, { prompt: "请输入密码", type: "password" }));
		demo.add(new UIGroup(this))
			.append($("label.demo-lbl").text("displayAsPwd: true"))
			.append(new UIInput(this, { prompt: "请输入密码", displayAsPwd: true }));
		demo.add(new UIGroup(this))
			.append($("label.demo-lbl").text("displayAsPwd: true, type: 'number'"))
			.append(new UIInput(this, { prompt: "请输入数字密码", type: "number", displayAsPwd: true}));
		demo.add(new UIGroup(this))
			.append($("label.demo-lbl").text("displayAsPwd: true, type: 'email'"))
			.append(new UIInput(this, { prompt: "输入邮箱作为密码", type: "email", displayAsPwd: true}));
	...
	renderDemo10: function (render) {
		...
		let demo = new UIGroup.VGroup(this, { gap: 10 });
		demo.append(new UIInput(this, { prompt: "请输入10个字之内的文本", maxSize: 10 }));
		demo.append(new UIInput(this, { prompt: "请输入备注信息", multi: true, maxSize: 120 }));
	...
	renderDemo11: function (render) {
		...
		let demo = new UIGroup.VGroup(this, { gap: 10 });
		demo.append(new UIInput(this, { prompt: "请输入", multi: true, width: "100%" }));
		demo.append(new UIInput(this, { prompt: "请输入内容", multi: true, autoHeight: true, 
